...
export const PEERS_DB_PATH = "./DB/peers.list";
export const OBJECT_DB_PATH = "./DB/objects.list";
export const UTXO_DB_PATH = "./DB/utxo.list";
export const BLOCK_HEIGHT_DB_PATH = "./DB/block_height_db.list";
