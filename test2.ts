...
function pseudorandomId(){
    return "0024839ec9632d382486ba7aac7e0bda3b4bda1d4bd79be9ae78e7e1e8" + Math.round(Math.random() * 100000).toString().padStart(6, '0');
}
function timeout(ms) {
...
async function test2(){
    ...
    console.log("Test 2 Sends a valid coinbase transaction object and asks for it back; sends a valid non-coinbase txn and asks for it back through two different nodes");
    console.log("Expecting: Transactions that were sent");
